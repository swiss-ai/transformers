...
class SwissAIConfig(LlamaConfig):
    ...
    Args:
        ...
        max_position_embeddings (`int`, *optional*, defaults to 32768):
            The maximum sequence length that this model might ever be used with. SwissAI supports up to 32768 tokens.
        ...
        pad_token_id (`int`, *optional*, defaults to 10):
            Padding token id.
        ...
        rope_theta (`float`, *optional*, defaults to 4000000.0):
